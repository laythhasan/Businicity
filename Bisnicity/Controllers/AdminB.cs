...
namespace Bisnicity.Controllers
{
    ...
    public class AdminB : Controller
    {
        ...
        public AdminB(IHostingEnvironment hosting, IBisnicity<Info> obisnicity,
          ...
          DataContext _Db, UserManager<ApplicationUser> _ouserManager, RoleManager<IdentityRole> _roleManager, ILogger<AdminB> logger, IApplictionUser<ApplicationUser> appliction)
        {
